...
export default function Consultants() {
  ...
  // Get the first 3 advisors or all advisors based on showAllAdvisors state
  const displayedAdvisors = showAllAdvisors ? advisors : advisors.slice(0, 3);
              ...
              <>
                ...
                {advisors.length > 3 && (
                  <div className="text-center mt-6">
                    ...
                    >
                      {showAllAdvisors ? 'Show Less' : 'Read More'}
                    </Button>
                  </div>
                )}
              </>
